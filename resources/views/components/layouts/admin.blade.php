        ...
        <aside class="sticky top-0 h-screen w-64 flex-shrink-0 bg-card-light dark:bg-card-dark border-r border-border-light dark:border-border-dark">
            <div class="flex h-full flex-col p-4">
                <div class="flex items-center gap-3 px-3 py-4">
                    ...
                    <h2 class="text-text-light-primary dark:text-text-dark-primary text-xl font-bold">CareBridge Admin</h2>
                </div>
                <div class="flex flex-col gap-4 mt-6 grow">
                    <div class="flex flex-col gap-2">
                        <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-primary/10 dark:bg-primary/20" href="{{ route('admin.dashboard') }}">
                        ...
                        <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 dark:hover:bg-primary/20 group" href="{{ route('admin.patients') }}">
                        ...
                        <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 dark:hover:bg-primary/20 group" href="{{ route('admin.doctors') }}">
                        ...
                        <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 dark:hover:bg-primary/20 group" href="{{ route('admin.appointments') }}">
                        ...
                        <!-- Wallet Management -->
                        <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 dark:hover:bg-primary/20 group" href="{{ route('admin.wallet.management') }}">
                            ...
                            <p class="text-text-light-primary dark:text-text-dark-primary group-hover:text-primary text-sm font-medium">Wallet Management</p>
                        </a>
                        
                        <!-- Wallet Transactions -->
                        <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 dark:hover:bg-primary/20 group" href="{{ route('admin.wallet.transactions') }}">
